...
namespace AgingInHome.Controllers
{
    public class UtitilityController : Controller
    {
        ...
        public bool Contactus(ContactUsModel _ContactUsModel)
        {
            ...
            _ContactUsModel.AppointmentDate = _ContactUsModel.IsMobileView == false
                ? Convert.ToDateTime(_ContactUsModel.AppointmentDate)
                : Convert.ToDateTime(_ContactUsModel.mbAppointmentDate);
            ...
            if (_ContactUsModel.IsCall == true || _ContactUsModel.MbCall == true)
            {
            ...
            if (_ContactUsModel.AppointmentSchedule == true || _ContactUsModel.MbAppointmentSchedule == true)
            {
